...
const FinancialMetrics = () => {
  return (
    <div
      className="box-border w-full h-min flex flex-col justify-center items-center bg-white shadow-metrics   overflow-hidden p-0 content-center flex-nowrap gap-0 rounded-3xl border border-solid border-[#222]"
      // initial={false}
