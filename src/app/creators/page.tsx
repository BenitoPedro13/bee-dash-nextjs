...
import useDataStore, { baseApiUrl, PostsPack, DashboardMode } from "@/store";
...
import grid from "@/../public/grade.svg";
import row from "@/../public/rows.svg";
...
export default function Home() {
  ...
  return (
    <div>
              ...
              >
                <TabsList>
                  <TabsTrigger value="grid">
                    <Image src={grid} width={20} height={20} alt="col" />
                  </TabsTrigger>

                  <TabsTrigger value="row">
                    <Image src={row} width={20} height={20} alt="col" />
                  </TabsTrigger>
                </TabsList>
              </Tabs>
            </div>
      ...
      <div className="w-full h-full xl:pl-[114px] relative z-20 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 pb-6 xl:pr-8 p-0 px-[15px]">
        {/*{campaigns.map((item) => {
        ...
        <CreatorCard name="teste" posts={2} />
